...
def menuPpal(user):
    ...
    if(user==4):
        ...
        if (desicion==1):
            ...
            HeatMap([[norte_GMSP[0], este_GMSP[0], 1]], name="Radiacion Centro", gradient={0.0: 'pink', 0.15: 'blue', 0.3: 'green',  0.7: 'yellow', 1: 'red'}, blur=10, radius=50, min_opacity=0.1).add_to(myMap)
